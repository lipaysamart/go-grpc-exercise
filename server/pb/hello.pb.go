...
type HelloRequest struct {
	...
	Name          string                 `protobuf:"bytes,1,opt,name=name,proto3" json:"name,omitempty"` // number is unique identifier
...
const file_pb_hello_proto_rawDesc = "" +
	...
	"\aGreeter\x12.\n" +
	"\bSayHello\x12\x10.pb.HelloRequest\x1a\x0e.pb.HelloReply\"\x00B3Z1github.com/lipaysamart/go-grpc-exercise/server/pbb\x06proto3"
